...
import * as ReportActions from './report-pass-statistic.actions'
...
import { getLoaded } from "./report-pass-statistic.selectors"
...
export const reportLoad$ = createEffect(
    (actions$ = inject(Actions), reportService = inject(ReportService)) =>
        actions$.pipe(
            ...
            exhaustMap(action => reportService.getReportPassStatistic(action.companyId)
                .pipe(
